...
class TableGenerator(ProcessedData):
    ...
    def format_ols_table(self, grid):
        ...
        return (
            ...
            .tab_spanner(label="Reading", columns=["(1)", "(2)", "(3)"], id="reading_5")
            .tab_spanner(label="Math", columns=["(4)", "(5)", "(6)"], id="math_5")
            .tab_spanner(label="Reading", columns=["(7)", "(8)", "(9)"], id="reading_4")
            .tab_spanner(label="Math", columns=["(10)", "(11)", "(12)"], id="math_4")
